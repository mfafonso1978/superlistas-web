      ...
      <div className="max-w-4xl mx-auto bg-slate-900/50 backdrop-blur-md rounded-2xl p-8 md:p-12 border border-white/5 shadow-xl">
        ...
        <div className="space-y-8 text-slate-300">
          ...
          <section>
            ...
            <p>
              Ao baixar, instalar ou utilizar o aplicativo Superlistas, você
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-3 marker:text-primary-500">
              <li>
                <strong className="text-white">Licença Limitada:</strong>{" "}
                Concedemos a você uma licença limitada, não exclusiva e
                intransferível para usar o aplicativo para fins pessoais e não
                comerciais.
              </li>
              <li>
                <strong className="text-white">Conta de Usuário:</strong> Para
                acessar recursos de sincronização, você precisa criar uma conta.
                Você é responsável por manter a confidencialidade de suas
                credenciais.
              </li>
              <li>
                <strong className="text-white">Conduta Proibida:</strong> É
                proibido usar o aplicativo para fins ilegais, tentar violar a
                segurança do sistema ou interferir no funcionamento do serviço.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-3 marker:text-primary-500">
              <li>
                <strong className="text-white">Plano Premium:</strong>{" "}
                Oferecemos recursos adicionais mediante assinatura. Os
                pagamentos são processados pela Google Play Store.
              </li>
              <li>
                <strong className="text-white">Renovação Automática:</strong> As
                assinaturas são renovadas automaticamente, a menos que sejam
                canceladas pelo menos 24 horas antes do fim do período atual.
              </li>
              <li>
                <strong className="text-white">Cancelamento:</strong> Você pode
                gerenciar e cancelar suas assinaturas nas configurações da sua
                conta da Google Play Store.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              Todo o conteúdo, design, gráficos, código e outros materiais
              relacionados ao Superlistas são propriedade da MFATECH e estão
              protegidos por leis de direitos autorais e propriedade
              intelectual.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              tipo. A MFATECH não se responsabiliza por:
            </p>
            <ul className="list-disc pl-5 space-y-3 marker:text-primary-500">
          ...
          <section>
            ...
            <p>
              ...
              quaisquer alterações. O uso contínuo do aplicativo após as
